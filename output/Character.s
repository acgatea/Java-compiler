...
; *****Start FieldDeclNode *****
global _java.lang.Character_FIELD_value
_java.lang.Character_FIELD_value:
mov ebp, esp
...
global _java.lang.Character_CONSTRUCTOR_Character#char#
_java.lang.Character_CONSTRUCTOR_Character#char#:
mov ebp, esp
; save registers
push esi
push ebx
...
; calls implicit constructor for Character
...
call _java.lang.Character_FIELD_value ; calls nonstatic field initializer
add esp, 0 ; pop arguments 
; load registers
pop ebp
pop edx
...
mov ebx, 0
cmp eax, ebx
jne _java.lang.Character_noError_1
call __exception ; nullpointerexception (field access)
_java.lang.Character_noError_1:
...
; *****END NameNode *****
; *****END unaryexprnode *****
_java.lang.Character_BinOpEndLabel_2:
; *****END BinOpExprNode *****
...
; *****Start ConstructorDeclarationNode *****
global _java.lang.Character_CONSTRUCTOR_Character#
_java.lang.Character_CONSTRUCTOR_Character#:
mov ebp, esp
; save registers
push esi
push ebx
...
; *****Start MethodHeader *****
global _java.lang.Character_METHOD_toString#
_java.lang.Character_METHOD_toString#:
mov ebp, esp
; *****END MethodHeader *****
...
mov ebx, 0
cmp eax, ebx
jne _java.lang.Character_noError_5
call __exception ; nullpointerexception (field access)
_java.lang.Character_noError_5:
add eax, 4 ; get address of nonstatic field value
mov eax, [eax] ; not LHS so get value
; *****END NameNode *****
; *****END unaryexprnode *****
_java.lang.Character_BinOpEndLabel_4:
; *****END BinOpExprNode *****
; *****END AssignmentExprNode *****
...
; *****END unaryexprnode *****
_java.lang.Character_BinOpEndLabel_3:
; *****END BinOpExprNode *****
; *****END AssignmentExprNode *****
mov esp, ebp
ret ; return
