...
; *****Start FieldDeclNode *****
global _java.lang.Short_FIELD_value
_java.lang.Short_FIELD_value:
mov ebp, esp
...
global _java.lang.Short_CONSTRUCTOR_Short#short#
_java.lang.Short_CONSTRUCTOR_Short#short#:
mov ebp, esp
; save registers
push esi
push ebx
...
; calls implicit constructor for Short
...
call _java.lang.Short_FIELD_value ; calls nonstatic field initializer
add esp, 0 ; pop arguments 
; load registers
pop ebp
pop edx
...
mov ebx, 0
cmp eax, ebx
jne _java.lang.Short_noError_1
call __exception ; nullpointerexception (field access)
_java.lang.Short_noError_1:
...
; *****END NameNode *****
; *****END unaryexprnode *****
_java.lang.Short_BinOpEndLabel_2:
; *****END BinOpExprNode *****
...
; *****Start MethodHeader *****
global _java.lang.Short_METHOD_intValue#
_java.lang.Short_METHOD_intValue#:
mov ebp, esp
; *****END MethodHeader *****
...
mov ebx, 0
cmp eax, ebx
jne _java.lang.Short_noError_4
call __exception ; nullpointerexception (field access)
_java.lang.Short_noError_4:
add eax, 4 ; get address of nonstatic field value
mov eax, [eax] ; not LHS so get value
; *****END NameNode *****
; *****END unaryexprnode *****
...
; *****END Cast Expr *****
; *****END unaryexprnode *****
_java.lang.Short_BinOpEndLabel_3:
; *****END BinOpExprNode *****
; *****END AssignmentExprNode *****
mov esp, ebp
ret ; return
...
; *****Start ConstructorDeclarationNode *****
global _java.lang.Short_CONSTRUCTOR_Short#
_java.lang.Short_CONSTRUCTOR_Short#:
mov ebp, esp
; save registers
push esi
push ebx
...
; *****Start MethodDeclaration *****
; *****Start MethodHeader *****
global _java.lang.Short_METHOD_toString#
_java.lang.Short_METHOD_toString#:
mov ebp, esp
; *****END MethodHeader *****
; *****Start ReturnStmt node *****
; *****Start AssignmentExprNode *****
...
mov ebx, 0
cmp eax, ebx
jne _java.lang.Short_noError_7
call __exception ; nullpointerexception (field access)
_java.lang.Short_noError_7:
add eax, 4 ; get address of nonstatic field value
mov eax, [eax] ; not LHS so get value
; *****END NameNode *****
; *****END unaryexprnode *****
_java.lang.Short_BinOpEndLabel_6:
; *****END BinOpExprNode *****
; *****END AssignmentExprNode *****
...
; *****END unaryexprnode *****
_java.lang.Short_BinOpEndLabel_5:
; *****END BinOpExprNode *****
; *****END AssignmentExprNode *****
mov esp, ebp
ret ; return
